drop schema ims_test1;
create schema if not exists ims_test1;
...
insert into ims_test1.customers(first_name, surname) values("Bob", "Perry");
insert into ims_test1.customers(first_name, surname) values("Friedrick", "Eisenhoff");